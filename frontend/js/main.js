...
async function cargarEstadisticas() {
    try {
        ...
        document.querySelector('.row.g-4 .col-md-3:nth-child(1) .stat-card h3').textContent = stats.auditoresActivos;
        document.querySelector('.row.g-4 .col-md-3:nth-child(2) .stat-card h3').textContent = stats.auditoriasFinalizadas;
        document.querySelector('.row.g-4 .col-md-3:nth-child(3) .stat-card h3').textContent = 
